...
public interface CassandraOperation {
    ...
    List<Map<String, Object>> getRecordsByOrder(String keyspaceName, String tableName, Map<String, Object> propertyMap, Integer limit,String orderDirection);

    Map<String,Object> deleteRecord(String keyspaceSunbirdCourses, String tableUserRecentSearch, Map<String, Object> propertyMap);
}
